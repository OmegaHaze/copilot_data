  ...
  try {
    ...
    for (const mod of allModules) {
      ...
      if (mod.module_type) {
        ...
        componentRegistry.setCategoryForModule(key, mod.module_type);
      }
    ...
    console.log('Registered component keys:', componentRegistry.getAllComponentKeys());
    componentRegistry.getAllComponentKeys().forEach(key => {
      console.log(`Component for key ${key}:`, componentRegistry.getComponent(key));
    });
