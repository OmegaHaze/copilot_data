...
export default function DefaultPane({ name, status, logo, moduleType, slug, error }) {
  ...
  return (
    <div className="w-full h-full bg-black rounded border border-green-600/60 shadow-inner overflow-hidden">
      <PaneHeader name={name || 'Unknown'} status={status || 'Error'} logo={logo} moduleType={moduleType} />
