///workspace/dashboard/client/src/components/Error-Handling/ErrorEffects.jsx
...
const ErrorEffects = ({ isActive }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-6 z-[9999]">
      ...
      <div 
        className="fixed inset-0 z-50 pointer-events-none scanlines boot-glow flash-flicker" 
        style={{ 
