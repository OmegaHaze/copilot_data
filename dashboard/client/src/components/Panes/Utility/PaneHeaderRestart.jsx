...
export default function PaneHeaderRestart({ paneName }) {
  ...
  if (!paneName || typeof paneName !== 'string') {
    console.log('PaneHeaderRestart: Missing paneName', paneName)
    return null
  }
  
  const serviceName = SUPERVISOR_SERVICE_MAP[paneName.toLowerCase()] || paneName.toLowerCase()
  
  // Always show the restart button for debugging purposes
  if (process.env.NODE_ENV === 'development') {
    console.log(`PaneHeaderRestart: paneName=${paneName}, serviceName=${serviceName}`);
  }
