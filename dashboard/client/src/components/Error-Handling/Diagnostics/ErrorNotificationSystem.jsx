...
export function ErrorProvider({ children }) {
  ...
  // This function is used by the error handler system through the context
  ...
  useEffect(() => {
    // This registers the showError function with the global error handler
    // to be used by non-React components
  ...
  }, [value, showError]) // Add showError as dependency to make TypeScript aware that it's used
