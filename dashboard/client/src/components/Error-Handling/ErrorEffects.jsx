...
const ErrorEffects = ({ isActive }) => {
  ...
  // Set to true for contained effects within a pane
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
      ...
      <div 
        className="absolute inset-0 pointer-events-none scanlines boot-glow flash-flicker" 
        style={{ 
      ...
      <div 
        className="absolute inset-0 z-50 pointer-events-none scan-pulse" 
        style={{
