...
# Modules
# -----------------------------
router.include_router(module_router, prefix="/api/module", tags=["Modules"])
router.include_router(api_modules_router, prefix="/api", tags=["API Modules"])
router.include_router(module_installer_router, prefix="/api/module/installer", tags=["Module Installation"])
router.include_router(reset_db_router, prefix="/api/module", tags=["Database Reset"])
